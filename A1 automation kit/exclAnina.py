...
with open('AninaBGL.txt', 'r') as file:
...
if not text_data.strip():  # Check if the text data is empty or contains only whitespace
    ...
    sheet = wb.sheets['ANINA']  # Select the sheet you want
...
wb.macro('ANINA')()  # Uncomment this line and replace 'ACTV' with the macro name if needed
