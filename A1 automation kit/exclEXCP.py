...
with open('Exceptional.txt', 'r') as file:
...
if not text_data.strip():  # Check if the text data is empty or contains only whitespace
    ...
    sheet = wb.sheets['EXCP']  # Select the sheet you want
...
# text_file_path = 'Exceptional.txt'
...
wb.macro('exceptional')()  # Uncomment this line and replace 'ACTV' with the macro name if needed
