...
with open('inoperative.txt', 'r') as file:
...
if not text_data.strip():  # Check if the text data is empty or contains only whitespace
    ...
    sheet = wb.sheets['INOP']  # Select the sheet you want
...
# text_file_path = 'inoperative.txt'
...
wb.macro('inop')()  # Uncomment this line and replace 'ACTV' with the macro name if needed
