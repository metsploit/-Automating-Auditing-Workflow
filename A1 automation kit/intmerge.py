...
def select_files():
    ...
    input_files = filedialog.askopenfilenames(
        title="select INTEREST_RATE_VARIATION.txt",
...
# Define the output file path with the name "Intrestrate.txt" in the same folder as the script
script_dir = os.path.dirname(os.path.abspath(__file__))  # Get the current script's directory
output_file = os.path.join(script_dir, "Intrestrate.txt")
